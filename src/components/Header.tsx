...
const Header: React.FC = () => 
{
    ...
    return (
        <div className=" flex justify-end pr-4 pt-3 space-x-4 items-center">
            ...
            <TbGridDots classname="text-4xl hover:bg-gray-200 rounded-full"/>
            <Image src={url} alt="dp" width={30} height={30} className="rounded-full object-cover" style={{height: 30}}/>
        </div>
    )
}
